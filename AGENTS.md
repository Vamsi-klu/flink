...
- Add, change, or remove classes outside the `org.apache.flink.*` package (for example, classes copied from Calcite)
- Modify `Parser.jj` (Calcite's generated parser grammar; expected to be removed in future Calcite upgrades)
